        ...
        <div className="space-y-4">
          ...
          {deliveryType === "pickup" && (
            <div className="space-y-2">
              ...
              <div className="w-full p-3 rounded-md bg-[#e4d699]/10 border border-[#e4d699]/30 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium">{selectedLocation.displayName}</div>
                    <div className="text-sm text-white/70">{selectedLocation.address}</div>
                  </div>
                  <Button
                    type="button"
                    variant="outline"
              ...
              <p className="text-xs text-white/60">
                Vill du hämta från en annan plats? Klicka på "Byt plats" ovan.
              </p>
            </div>
          )}
