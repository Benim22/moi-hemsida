...
import { useLocation, locations, type Location } from '@/contexts/LocationContext'
import { MapPin, Clock, Phone, Star, Truck, ShoppingBag, Utensils, X } from 'lucide-react'

export function LocationSelector() {
  const { showLocationSelector, setSelectedLocation, setShowLocationSelector } = useLocation()
