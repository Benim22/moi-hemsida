...
export default function HeroSection({
  ...
  videoSrc = 'https://videos.pexels.com/video-files/3295852/3295852-uhd_2732_1440_25fps.mp4',
  imageSrc = 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=800&h=600&fit=crop&crop=center',
  showCTAs = true,
  location
}: HeroSectionProps) {
  ...
  return (
    <section className="hero-section relative overflow-hidden h-[600px]">
      {/* Video Background */}
      {!videoError && (
        <video
          autoPlay
